...
namespace KoboldMountain
{
	public class SpriteClass
	{
		...
		{
			Vector2 spritePosition = new Vector2((X + Camera.X) * Camera.zoom, (Y + Camera.Y) * Camera.zoom); // hopefully adding zoom here will make the positions change relative to the camera. Word.
